...
public interface SlManage
{
    ...
    public interface Async
    {
        ...
        @ThriftMethod(value = "loadRedis",
                      exception = {
                          @ThriftException(type=com.pg.sl.api.client.exception.SlException.class, id=1)
                      })
    ...
    boolean loadRedis() throws com.pg.sl.api.client.exception.SlException, org.apache.thrift.TException;
}